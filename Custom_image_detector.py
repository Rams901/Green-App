...
from utils import vis_stickers as vis_util

# Name of the directory containing the object detection module we're using
MODEL_NAME = 'inference_graph'
IMAGE_NAME = 'images(34)'
...
#PATH_TO_IMAGE = "C:/Tensorflow/models/research/object_detection/images/test/monstera-baby-plant-royalty-free-image-1133859657-1553276209.jpg
...
image = cv2.imread("C:/tensorflow/models/research/object_detection/train/test/d50a8cacbf0adf3f.jpg")
image = cv2.imread("C:/Users/r901/Desktop/20200621_114819.jpg")
...
#Randomly picking a sticker to use:
import random
...
vis_util.visualize_boxes_and_labels_on_image_array(
    image,
    np.squeeze(boxes),sticker_list[index],
